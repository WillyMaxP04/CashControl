...
public class AddGasto extends javax.swing.JFrame {
    ...
    public void setUsuario(Usuario usuario){
        this.usu = usuario;
        NumRegistro = usuario.calcu.contI;
    }
    ...
    private void initComponents() {
        ...
        Tittle.setText("Creador de gastos");
    ...
    private void CrearBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CrearBtnMouseClicked
        ...
        if(CicloC.isSelected()){
            TipoDeCiclo = true;
            usu.AñadirGasto(Categoria, MedioDePago, TipoDeCiclo, Magnitud, NumCuotas, Entidad);
