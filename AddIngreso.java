...
public class AddIngreso extends javax.swing.JFrame {
    ...
    Boolean TipoDeCiclo = false, Tipo = false;
    Float Magnitud;
    int NumCuotas;
    ...
    private void initComponents() {
        ...
        Tittle.setText("Creador de ingresos");
    ...
    private void CatFileMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CatFileMousePressed
        if(CatFile.getText().equals("Categoria / Tipo")){
            CatFile.setText("");
        }
    ...
    private void MedioFileMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MedioFileMousePressed
        if(MedioFile.getText().equals("Medio de pago")){
            MedioFile.setText("");
        }
    ...
    private void ValorFileMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ValorFileMousePressed
        if(ValorFile.getText().equals("Valor")){
            ValorFile.setText("");
        }
    ...
    private void CuotasFileMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CuotasFileMousePressed
        if(CuotasFile.getText().equals("Num cuotas")){
            CuotasFile.setText("");
        }
    ...
    private void CrearBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CrearBtnMouseClicked
        ...
        if(CicloC.isSelected()){
            ...
            if(TipoA.isSelected()) {
                Tipo = true;
                usu.AñadirIngreso(Categoria,MedioDePago,TipoDeCiclo,Magnitud,NumCuotas,Tipo);
                JOptionPane.showMessageDialog(null, "Ingreso añadido correctamente");
                ListaIngresos menu = new ListaIngresos();
                menu.setUsuarioI(usu);
                menu.setTotal();
                menu.setLista();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddIngreso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddIngreso().setVisible(true);
            }
        });
    }
