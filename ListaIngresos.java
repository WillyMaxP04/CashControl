...
public class ListaIngresos extends javax.swing.JFrame {
    Usuario usuario;
    int ingresoselect;
    DefaultListModel modelo = new DefaultListModel();
    ArrayList listaI = new ArrayList();
    String NoHay = "Actualmente no hay ningun ingreso registrado";
    ...
    public void setUsuarioI(Usuario usuario){
       this.usuario = usuario;
    }
    
    public void setTotal(){
        TotalTxt.setText("Total: $"+usuario.calcu.SumaIngresos(0));
    }
    
    void setLista() {
        for(int i=0;i<usuario.Ingresos.size();i++){
            listaI.add(usuario.LecturaIngresos1(i));
            listaI.add(usuario.LecturaIngresos2(i));
        }
        ...
        for(int i=0;i<listaI.size();i++){
            modelo.addElement(listaI.get(i));
        }
    }
    ...
    private void initComponents() {
        ...
        Superior.setBackground(new java.awt.Color(130, 231, 196));
        ...
        SpueriorTxt.setText("Gestión de Ingresos");

        Return.setBackground(new java.awt.Color(130, 231, 196));
        ...
        TotalPanel.setBackground(new java.awt.Color(118, 209, 190));
        ...
        TittlePanel.setBackground(new java.awt.Color(118, 209, 190));
        ...
        TittleTxt.setText("Lista de ingresos");
        TittleTxt.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TittleTxtMouseClicked(evt);
            }
        });
    ...
    private void ModifTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ModifTxtMouseClicked
        if(!listaI.isEmpty()) {
            ingresoselect = Integer.parseInt(JOptionPane.showInputDialog(null,"Digite el numero de registro del ingreso a modificar:"));
            ingresoselect--;
            ModIngreso modificar = new ModIngreso();
            modificar.setUsuario(usuario,ingresoselect);
    ...
    private void AddBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddBtnMouseClicked
        AddIngreso añadir = new AddIngreso();
    ...
    private void DeleteBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DeleteBtnMouseClicked
        if(!listaI.isEmpty()) {
            ingresoselect = Integer.parseInt(JOptionPane.showInputDialog(null,"Digite el numero del ingreso que desea modificar:"));
            ingresoselect--;
            usuario.EliminarIngreso(ingresoselect);
    ...
    private void TittleTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TittleTxtMouseClicked
        
    }//GEN-LAST:event_TittleTxtMouseClicked

    public static void main(String args[]) {

        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaIngresos().setVisible(true);
            }
        });
    }
